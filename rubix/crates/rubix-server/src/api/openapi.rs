...
#[openapi(
    ...
    paths(
        ...
        boards::options::list_options,
        boards::outputs::board_outputs,
        boards::outputs_stream::board_outputs_stream,
    ...
    components(schemas(ErrorBody, RunRecord, RunStatus, RunOrigin, PendingWrite,
        ...
        boards::components::ConfigFieldView, boards::options::OptionView,
        crate::scheduler::PortOutput,
