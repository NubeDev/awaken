// shadcn/ui Checkbox (new-york). Vendored; wraps Radix Checkbox and themes via
// the semantic tokens in styles/theme.css — checked state is the Rubix primary
// (--r1), matching the accent the raw <input> checkboxes used before.
