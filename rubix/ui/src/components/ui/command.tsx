// shadcn/ui Command (new-york), vendored on `cmdk`. The composable primitive
// behind comboboxes/command palettes: a filtered, keyboard-navigable list with a
// search input. Themed via styles/theme.css tokens.
