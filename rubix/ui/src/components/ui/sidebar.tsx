// shadcn/ui Sidebar — the floating inset sidebar shell (provider + container +
// menu primitives). Vendored from satnaing/shadcn-admin and adapted: RTL logical
// utilities (inset-s/e, border-s/e) rewritten as physical (left/right, border-l/r)
// since the app is LTR-only, and the persisted-state cookie reads SIDEBAR_COOKIE.
// Colors come from the --sidebar-* tokens in styles/theme.css.
...
function SidebarMenuSkeleton({
  ...
  // Stable per-mount width between 50% and 90% (no Math.random at module scope).
